...
<head>
  ...
  <script src="social_info.js"></script>
  ...
  <title>บทบาททางสังคมปัจจุบัน</title>
  <style>
    body {
...
<body ng-controller="chronic_crt">
  ...
  <h1 class="text-center mt-4">ตารางแสดงรายการบทบาททางสังคมปัจจุบัน</h3>
        ...
        <table id="table-sample" class="table table-striped table-hover" ng-init="getdata()">
          <thead>
            <tr>
              ...
              <th scope="col">Soc_Year</th>
              <th scope="col">SocID</th>
              <th scope="col">SocName</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form ng-submit="senddata()">
              ...
              <div class="row mb-3">
                <label for="input1" class="col-sm-2 col-form-label">Soc_Year</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input1" ng-model="f.d" />
                </div>
              </div>
              <div class="row mb-3">
                <label for="input2" class="col-sm-2 col-form-label">SocID</label>
                <div class="col-sm-10">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form ng-submit="update()">
              ...
              <div class="row mb-3">
                <label for="input2" class="col-sm-2 col-form-label">Soc_Year</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input2" ng-model="xyz.Soc_Year" />
                </div>
              </div>
              <div class="row mb-3">
                <label for="input2" class="col-sm-2 col-form-label">SocID</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input2" ng-model="xyz.SocID" />
                </div>
              </div>
              <!-- <div class="row mb-3">
                <label for="input3" class="col-sm-2 col-form-label">SocName</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input3" ng-model="xyz.SocName" />
                </div>
              </div> -->
