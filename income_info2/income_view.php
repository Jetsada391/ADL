...
<head>
  ...
  <script src="income_info2.js"></script>
...
<body ng-controller="chronic_crt">
  ...
  <h1 class="text-center mt-4">ตารางแสดงรายการแหล่งรายได้</h3>
    ...
    <table id="table-sample" class="table table-striped table-hover" ng-init="getdata()">
      <thead>
        <tr>
          ...
          <!-- <th scope="col">รหัสแหล่งรายได้</th> -->
          <th scope="col">ปี</th>
          <th scope="col">แหล่งรายได้ของตนเอง</th>
        ...
        <div class="modal-body">
          ...
          <form ng-submit="senddata()">
            <div class="row mb-3">
              ...
              <div class="row mb-3">
                <label for="input2" class="col-sm-2 col-form-label">S_incomeID </label>
                <div class="col-sm-10">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="update()">
            ...
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">S_incomeID</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input2" ng-model="xyz.S_incomeID" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="input1" class="col-sm-2 col-form-label">ID_Year</label>
