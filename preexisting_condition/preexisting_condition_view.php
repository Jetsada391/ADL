...
<head>
  ...
  <script src="preexisting_condition.js"></script>
...
<body ng-controller="chronic_crt">
  ...
  <h1 class="text-center mt-4">ตารางแสดงรายการสถานที่รักษา</h3>
    ...
    <table id="table-sample" class="table table-striped table-hover" ng-init="getdata()">
      <thead>
        <tr>
          ...
          <!-- <th scope="col">PcdisID</th> -->
          <th scope="col">ปี</th>
          <th scope="col">สถานที่รักษา</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="senddata()">
            ...
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">PcdisID</label>
              <div class="col-sm-10">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="update()">
            ...
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">PcdisID</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input2" ng-model="xyz.PcdisID" />
              </div>
            </div>
            <div class="row mb-3">
