...
app.controller("chronic_crt", ['$scope', '$http', '$timeout',
  function ($scope, $http, $timeout) {
    ...
    $scope.senddata = function () {
      $http({
        method: 'post',
        url: "preexisting_condition_insert.php",
        data: $scope.f,
    ...
    $scope.getdata = function () {
      $http({
        method: 'post',
        url: "preexisting_condition_select_frm.php",
        data: $scope.f,
        headers: { "Content-type": "application/x-www-form-urlencoded" }
      }).then(
        function (A) {
...
$('#table-sample').DataTable().destroy();
    ...
    $scope.deldata = function (will_be_deleted) {
      ...
      $http({
        method: 'post',
        url: "preexisting_condition_delete.php",
    ...
    $scope.update = function () {
      $http({
        method: 'post',
        url: "preexisting_condition_update_prg.php",
        data: $scope.xyz,
        headers: { "Content-type": "application/x-www-form-urlencoded" }
      }).then(
        function (A) {
