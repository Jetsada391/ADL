...
<head>
  ...
  <title>สถานการณ์อยู่อาศัย</title>
  <style>
    body {
...
<?php include_once('../menu.php');?>
  <h1 class="text-center mt-4">ตารางแสดงรายการสถานการณ์อยู่อาศัย</h3>
    ...
    <table id="table-sample" class="table table-striped table-hover" ng-init="getdata()">
      <thead>
        <tr>
          ...
          <th scope="col">SituID</th>
          <th scope="col">Situ_Name</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="senddata()">
            ...
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">สถานการณ์อยู่อาศัย</label>
              <div class="col-sm-10">
                <span  class="nullable">
                  <select ng-model="f.c" >
                    <option value="">-- ตัวเลือก --</option>
                    <option ng-repeat="i in situationlist" value="{{i.situID}}">{{i.Situ_Name}}</option>
                  </select>
                </span>
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="update()">
            ...
            <div class="row mb-3">
              <label for="input1" class="col-sm-2 col-form-label">ID_Year</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input2" ng-model="xyz.ID_Year"/>
              </div>
            </div>
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">SituID</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input2" ng-model="xyz.SituID" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="input3" class="col-sm-2 col-form-label">Situ_Name</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input3" ng-model="xyz.Situ_Name" />
              </div>
            </div>
