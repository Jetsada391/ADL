...
<head>
  ...
  <script src="sleep_detail.js"></script>
  ...
  <title>การประเมินปัญหาการนอน</title>
  <style>
    body {
...
<body ng-controller="chronic_crt">
  ...
  <h1 class="text-center mt-4">ตารางแสดงรายการการประเมินปัญหาการนอน</h3>
    ...
    <table id="table-sample" class="table table-striped table-hover" ng-init="getdata()">
      <thead>
        <tr>
          ...
          <th scope="col">sleep_detailID </th>
          <th scope="col">sleep_detailName	</th>
      ...
      <tbody>
        ...
        <tr ng-repeat="i in alltype">
          <td>{{i.IDCard}}</td>
          <td>{{i.ID_Year}}</td>
          <td>{{i.sleep_detailID}}</td>
          <td>{{i.sleep_detailName}}</td>
          <td>
            <button class="btn btn-danger" ng-click="confirmDal(i)">
              ลบ
            </button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="senddata()">
            ...
            <div class="row mb-3">
              <label for="input2" class="col-sm-2 col-form-label">sleep_detailID</label>
              <div class="col-sm-10">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form ng-submit="update()">
            ...
            <div class="row mb-3">
              <label for="input3" class="col-sm-2 col-form-label">sleep_detailID</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input3" ng-model="xyz.sleep_detailID" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="input4" class="col-sm-2 col-form-label">sleep_detailName</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input3" ng-model="xyz.sleep_detailName" />
              </div>
            </div>
